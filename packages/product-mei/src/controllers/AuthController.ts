import { LoginCredentials, RegisterData, UserModel, User } from '../models/User';
import { toast } from '../hooks/use-toast';
import { SupabaseMeiAuthService } from '../lib/services/SupabaseMeiAuthService';
import { DICategoryController } from './DICategoryController';

// Instanciar o serviço de autenticação Supabase
const authService = new SupabaseMeiAuthService();
    ...
    try {
      ...
      toast({
        title: "Login realizado com sucesso!",
          description: `Bem-vindo ao FinManage MEI, ${result.user?.name}`,
      });
      return true;
      } else {
        toast({
