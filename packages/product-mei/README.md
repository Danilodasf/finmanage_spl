...
```
feat: adiciona nova funcionalidade de DAS
fix: corrige cálculo de vencimento
docs: atualiza documentação da API
test: adiciona testes para validação
refactor: melhora estrutura do DI
```

---

<div align="center">
  <p><strong>FinManage MEI</strong> - Gestão Financeira Inteligente para Microempreendedores</p>
</div>